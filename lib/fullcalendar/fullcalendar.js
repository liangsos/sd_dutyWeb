    ...
    */
    ...
    function BasicView(element, calendar, viewName) {
        ...
        function buildEventContainer() {
            daySegmentContainer =
                $("<div class='fc-event-container' style='position:absolute;z-index:0;top:0;left:0'/>")
                    .appendTo(element);
        }
        ...
        function buildCellHTML(date) {
            ...
            if (showNumbers) {
                html += "<div class='fc-day-number-right'>" + date.getDate() + "</div>";
                // modified by feifei.im 增加节气显示
                //var cTerm = lunar(date).term;
                //if (cTerm) {
                //    html += "<div class='fc-d ay-cnTerm'>" + cTerm + "</div>";
                //}
